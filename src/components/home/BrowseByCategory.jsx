    ...
    <section id="section-category" className="no-top">
      <div className="container">
        <div className="row">
          ...
          <div data-aos="fade-left" data-aos-delay="100" className="col-md-2 col-sm-4 col-6 mb-sm-30">
          ...
          <div data-aos="fade-left" data-aos-delay="300" className="col-md-2 col-sm-4 col-6 mb-sm-30">
            <Link to="/explore" className="icon-box style-2 rounded">
          ...
          <div data-aos="fade-left" data-aos-delay="500" className="col-md-2 col-sm-4 col-6 mb-sm-30">
            <Link to="/explore" className="icon-box style-2 rounded">
